...
summary: 'Retrieve attributes of an EBR policy'
---

= Retrieve attributes of an EBR policy

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/storage/snaplock/event-retention/policies/{policy.name}`#
