...
| 5440501
| The specified storage unit size is insufficient.
...
| 53412040
| Splitting a non-snaplock clone from a Snaplock consistency group during clone creation is not supported.
|===
