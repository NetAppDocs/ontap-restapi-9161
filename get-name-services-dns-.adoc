...
summary: 'Retrieve the DNS domain and server configuration for an SVM'
---

= Retrieve the DNS domain and server configuration for an SVM

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/dns/{uuid}`#
