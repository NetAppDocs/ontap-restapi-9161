...
| 9044021
| The specified authentication protocol is not supported when cluster FIPS mode is enabled.

| 9044022
| The specified privacy protocol is not supported when cluster FIPS mode is enabled.
|===
