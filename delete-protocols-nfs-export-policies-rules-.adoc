...
api: true
explorer: false
permalink: 'delete-protocols-nfs-export-policies-rules-.html'
summary: 'Delete an export policy rule'
---

= Delete an export policy rule

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/protocols/nfs/export-policies/{policy.id}/rules/{index}`#
