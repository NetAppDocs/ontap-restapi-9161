...
api: true
explorer: false
permalink: 'delete-cluster-ntp-servers-.html'
summary: 'Delete an external NTP server'
---

= Delete an external NTP server

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/cluster/ntp/servers/{server}`#
