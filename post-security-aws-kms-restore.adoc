...
api: true
explorer: false
permalink: 'post-security-aws-kms-restore.html'
summary: 'Restore keys for an SVM from a configured AWS KMS'
---

= Restore keys for an SVM from a configured AWS KMS

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/security/aws-kms/{aws_kms.uuid}/restore`#
