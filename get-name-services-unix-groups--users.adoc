...
[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/unix-groups/{svm.uuid}/{unix_group.name}/users`#
...
|num_records
|integer
a|Number of UNIX user records in a given SVM and group.


|records
|array[link:#unix_group_users[unix_group_users]]
a|
