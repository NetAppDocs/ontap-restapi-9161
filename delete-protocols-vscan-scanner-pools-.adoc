...
summary: 'Delete the Vscan scanner-pool configuration'
---

= Delete the Vscan scanner-pool configuration
...
//end row
//start row
|Attempting to delete a scanner-pool with a data SVM which was created by the SVM owned by the cluster
//end row
|===
//end table
