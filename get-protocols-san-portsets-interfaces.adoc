...
summary: 'Retrieve portset network interfaces'
---

= Retrieve portset network interfaces

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/protocols/san/portsets/{portset.uuid}/interfaces`#
