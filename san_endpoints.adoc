...
The Fibre Channel Protocol (FCP) service REST API allows you to create, update, delete, and discover Fibre Channel Services for SVMs.
...
The initiator group REST API allows you to create, update, delete, and discover initiator groups. It also enables you to add and remove initiators that can access the target and associated LUNs.
...
The portset REST API allows you to create, delete, and discover portsets, and to add and remove network interfaces from portsets.
