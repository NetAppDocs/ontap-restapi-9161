...
api: true
explorer: false
permalink: 'post-support-ems-filters-rules.html'
summary: 'Create an event filter rule'
---

= Create an event filter rule

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/support/ems/filters/{name}/rules`#
