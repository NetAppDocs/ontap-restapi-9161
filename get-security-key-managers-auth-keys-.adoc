...
summary: 'List all authentication keys associated with the admin SVM'
---

= List all authentication keys associated with the admin SVM

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/security/key-managers/{security_key_manager.uuid}/auth-keys/{key_id}`#
...
|path
|True
a|Key ID of the authentication key to be retrieved.
