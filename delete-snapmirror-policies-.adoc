...
api: true
explorer: false
permalink: 'delete-snapmirror-policies-.html'
summary: 'Delete a SnapMirror policy'
---

= Delete a SnapMirror policy

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/snapmirror/policies/{uuid}`#
