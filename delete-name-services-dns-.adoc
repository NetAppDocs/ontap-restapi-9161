...
summary: 'Delete the DNS domain configuration for an SVM'
---

= Delete the DNS domain configuration for an SVM

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/name-services/dns/{uuid}`#
