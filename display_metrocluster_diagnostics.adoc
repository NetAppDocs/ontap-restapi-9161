...
----
curl -X GET https://<mgmt-ip>/api/cluster/metrocluster/diagnostics?fields=node.details
----
...
----
curl -X GET https://<mgmt-ip>/api/cluster/metrocluster/diagnostics?fields=volume.details
----
