...
api: true
explorer: false
permalink: 'manage_fpolicy_configuration.html'
summary: 'Manage FPolicy configuration'
---
...
To create an FPolicy for an SVM use the following API. Note that the _return_records=true_ query parameter is used to obtain the newly created entry in the response.
...
#The call:
curl -X POST "https://<mgmt-ip>/api/protocols/fpolicy?return_records=true" -H "accept: application/json" -H "Content-Type: application/json" -d "{ \"engines\": [ { \"name\": \"engine1\", \"port\": 9876, \"primary_servers\": [ \"10.132.145.22\", \"10.140.101.109\" ], \"secondary_servers\": [ \"10.132.145.20\", \"10.132.145.21\" ], \"type\": \"synchronous\", \"format\": \"xml\" } ], \"events\": [ { \"file_operations\": { \"read\": true, \"write\": true }, \"filters\": { \"monitor_ads\": true }, \"name\": \"event_cifs\", \"protocol\": \"cifs\", \"volume_monitoring\": true } ], \"policies\": [ { \"engine\": { \"name\": \"engine1\" }, \"events\": [ { \"name\": \"event_cifs\" } ], \"mandatory\": true, \"name\": \"pol0\", \"priority\": 1, \"scope\": { \"include_volumes\": [ \"vol1\" ] } } ], \"persistent_stores\": [ { \"name\": \"ps1\", \"volume\": \"psvol\" ,\"size\": 1073741824, \"autosize_mode\": \"off\"} ], \"svm\": { \"name\": \"vs1\", \"uuid\": \"b34f5e3d-01d0-11e9-8f63-0050568ea311\" }}"
