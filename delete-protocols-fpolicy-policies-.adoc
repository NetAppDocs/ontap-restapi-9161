...
api: true
explorer: false
permalink: 'delete-protocols-fpolicy-policies-.html'
summary: 'Delete an FPolicy configuration for an SVM'
---

= Delete an FPolicy configuration for an SVM

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/protocols/fpolicy/{svm.uuid}/policies/{name}`#
...
| 9764900
| Deletion of a cluster level FPolicy policy is not supported
|===
