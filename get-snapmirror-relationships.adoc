...
|destination.luns.name
|string
|query
|False
a|Filter by destination.luns.name

* Introduced in: 9.16


|destination.luns.uuid
|string
|query
|False
a|Filter by destination.luns.uuid
