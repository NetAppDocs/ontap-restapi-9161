...
api: true
explorer: false
permalink: 'delete-storage-aggregates-cloud-stores-.html'
summary: 'Remove a cloud target from an aggregate'
---

= Remove a cloud target from an aggregate

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/storage/aggregates/{aggregate.uuid}/cloud-stores/{target.uuid}`#
