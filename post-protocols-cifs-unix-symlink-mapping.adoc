...
| 655437
| Failed to create the symlink mapping with locality "local" because the target share does not exist for the specified SVM
...
| 656481
| Failed to create the widelink because the target share does not exist for the specified SVM
|===
