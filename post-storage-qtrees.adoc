...
| 5242978
| The maximum number of qtrees for which extended performance monitoring can be enabled has been reached. Retry the POST request with ext_performance_monitoring.enabled set to false.

| 5242979
| Qtree creation succeeded but failed to enable extended performance monitoring on the qtree.
