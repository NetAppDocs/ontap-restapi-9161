...
_/api/security/accounts/?owner.name=+++<svm-name>+++</i> for a specific SVM This API response contains the complete URI for each user account that can be used.+++</svm-name>+++_
