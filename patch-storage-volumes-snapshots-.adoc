...
summary: 'Update a volume snapshot'
---
...
| 524508
| The snapshot was not renamed because the name entered is not valid.

| 542797
| The specified file or snapshot does not exist.

| 1638455
| Failed to set comment for snapshot.

| 1638476
| You cannot rename a snapshot created for use as a reference snapshot by other jobs.
...
| 1638522
| Snapshots can only be renamed on read/write (RW) volumes.

| 1638523
| Failed to set the specified SnapMirror label for the snapshot.

| 1638524
| Adding SnapMirror labels is not allowed in a mixed version cluster.

| 1638539
| Cannot determine the status of the snapshot rename operation for the specified volume.

| 1638554
| Failed to set expiry time for the snapshot.
